...
def tenfcv(regfun, feature='feature', cho=[1], ratio=0.5, alpha=0.5, kernel='rbf', C=1, gamma=1.0,
...
def main():
    ...
    for i in range(0, 12):
        print 'without', s[i]
        ch = [i]
        curScore, cur5, cur10, cur20 = tenfcv(svr, feature='feature_12cut', cho=ch, ratio=0.6, kernel='rbf',
                                              C=6, gamma=1.0, iters=10)
