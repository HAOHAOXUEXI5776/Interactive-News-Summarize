...
# 该模型的得分。得分越高，说明越准确。
def tenfcv(regfun, feature='feature', delete=[], ratio=0.8, alpha=0.5, kernel='rbf', C=4, gamma=1,
...
def main():
    ...
    # svr回归
    score, P_5, P_10, P_20 = tenfcv(svr, feature=feature, delete=delete, ratio=0.8, kernel='rbf', C=4, gamma=1.0)
